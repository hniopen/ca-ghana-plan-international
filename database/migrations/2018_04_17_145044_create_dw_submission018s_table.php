...
class CreateDwSubmission018sTable extends Migration {
	...
	public function up()
	{
		Schema::create('dw_submission018s', function(Blueprint $table)
		{
			$table->increments('id');
			...
			$table->text('deliveries', 65535)->nullable();
			$table->text('deliveries__locdel', 65535)->nullable();
			$table->text('deliveries__locdeL_oth', 65535)->nullable();
			$table->text('deliveries__delcon', 65535)->nullable();
			$table->text('deliveries__if_oth', 65535)->nullable();
			$table->text('deliveries__select_category_del', 65535)->nullable();
			$table->text('deliveries__age15_del', 65535)->nullable();
			$table->string('deliveries__age15_del__ancdel1_1', 20)->nullable();
			$table->text('deliveries__age20_49_del', 65535)->nullable();
			$table->string('deliveries__age20_49_del__ancdel2_1', 20)->nullable();
			$table->text('deliveries__age20_49_del__ancdel_total', 65535)->nullable();
			$table->text('deliveries__age20_49_del__ancdel_total_display', 65535)->nullable();
			$table->text('babies_del', 65535)->nullable();
			$table->text('babies_del__sex_agg', 65535)->nullable();
			$table->string('babies_del__boys_del', 20)->nullable();
			$table->string('babies_del__girls_del', 20)->nullable();
			$table->text('babies_del__tot_del', 65535)->nullable();
			$table->text('babies_del__tot_del_display', 65535)->nullable();
