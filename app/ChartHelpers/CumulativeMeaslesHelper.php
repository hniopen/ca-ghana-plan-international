 ...
 *
 */
class CumulativeMeaslesHelper {

	public $C3FormatData = array();

    function __construct($measlesData, $yLabel = NULL) {
      $this->C3FormatData = (new CumulativeChartHelper($measlesData, false, [NULL, 'vaccinated'], $yLabel))->C3FormatData;
    }
