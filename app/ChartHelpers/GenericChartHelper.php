 ...
 *
 */
class GenericChartHelper {

	private $percentageTimeSeries = array();
    ...
    function __construct($numeratorData, $denominatorData, $zipKeys, $yLabel = NULL) {
      ...
      $zippedArrays = self::zipArrays($numeratorData, $denominatorData, $zipKeys);
      $this->percentageTimeSeries = $this->convertToPercentageTimeseries($zippedArrays);
      $this->C3FormatData = $this->convertToC3FormatData($this->percentageTimeSeries);
    }
