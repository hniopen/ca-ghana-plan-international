 ...
 *
 */
class CumulativeANCHelper {

	public $C3FormatData = array();

    function __construct($ANCVisitData, $deliveryData, $yLabel = NULL) {
      $this->C3FormatData = (new CumulativeChartHelper($ANCVisitData, $deliveryData, ['deliveries', 'ANC_count'], $yLabel))->C3FormatData;
    }
