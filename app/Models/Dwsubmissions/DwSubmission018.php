...
/**
 * Class DwSubmission018
 * @package App\Models\Dwsubmissions
 * @version January 31, 2018, 10:53 am UTC
 *
 ...
 * @property string deliveries__locdel
 * @property string deliveries__locdeL_oth
 * @property string deliveries__delcon
 * @property string deliveries__if_oth
 * @property string deliveries__select_category_del
 * @property string deliveries__age15_del
 * @property string deliveries__age15_del__ancdel1_1
 * @property string deliveries__age20_49_del
 * @property string deliveries__age20_49_del__ancdel2_1
 * @property string deliveries__age20_49_del__ancdel_total
 * @property string deliveries__age20_49_del__ancdel_total_display
 * @property string babies_del
 * @property string babies_del__sex_agg
 * @property string babies_del__boys_del
 * @property string babies_del__girls_del
 * @property string babies_del__tot_del
 * @property string babies_del__tot_del_display
 * @property string pnc
 ...
 */
class DwSubmission018 extends Model
{

    public $table = 'dw_submission018s';
 ...
 */
    ...
    public $fillable = [
        ...
        'deliveries',
        'deliveries__locdel',
        'deliveries__locdeL_oth',
        'deliveries__delcon',
        'deliveries__if_oth',
        'deliveries__select_category_del',
        'deliveries__age15_del',
        'deliveries__age15_del__ancdel1_1',
        'deliveries__age20_49_del',
        'deliveries__age20_49_del__ancdel2_1',
        'deliveries__age20_49_del__ancdel_total',
        'deliveries__age20_49_del__ancdel_total_display',
        'babies_del',
        'babies_del__sex_agg',
        'babies_del__boys_del',
        'babies_del__girls_del',
        'babies_del__tot_del',
        'babies_del__tot_del_display',
        'pnc',
        'pnc__mother',
    ...
    protected $casts = [
        ...
        'deliveries' => 'string',
        'deliveries__locdel' => 'string',
        'deliveries__locdeL_oth' => 'string',
        'deliveries__delcon' => 'string',
        'deliveries__if_oth' => 'string',
        'deliveries__select_category_del' => 'string',
        'deliveries__age15_del' => 'string',
        'deliveries__age15_del__ancdel1_1' => 'string',
        'deliveries__age20_49_del' => 'string',
        'deliveries__age20_49_del__ancdel2_1' => 'string',
        'deliveries__age20_49_del__ancdel_total' => 'string',
        'deliveries__age20_49_del__ancdel_total_display' => 'string',
        'babies_del' => 'string',
        'babies_del__sex_agg' => 'string',
        'babies_del__boys_del' => 'string',
        'babies_del__girls_del' => 'string',
        'babies_del__tot_del' => 'string',
        'babies_del__tot_del_display' => 'string',
        'pnc' => 'string',
        'pnc__mother' => 'string',
	...
	private static function maleBirthsSelectStrings() {
		return array_merge([
			self::$dateSelect,
			"SUM(babies_del__boys_del) as births"
		]);
	}
	private static function femaleBirthsSelectStrings() {
		return array_merge([
			self::$dateSelect,
			"SUM(babies_del__girls_del) as births"
		]);
	}
	private static function deliveriesSelectStrings15To19($asWhat) {
		return array_merge([
			self::$dateSelect,
			"SUM(deliveries__age15_del__ancdel1_1) as ".$asWhat
		]);
	}
	private static function deliveriesSelectStrings20To49($asWhat) {
		return array_merge([
			self::$dateSelect,
			"SUM(deliveries__age20_49_del__ancdel2_1) as ".$asWhat
		]);
	}
	private static function applyDeliveriesWhere($query) {
		return $query->whereIn('deliveries__locdel', ['chps_choice', 'health_choice', 'poly_choice']);
	}

	private static function applySkilledHealthWorkerDeliveriesWhere($query) {
		return $query->whereNotIn('deliveries__delcon', ['other', 'tba']);
	}
	...
	//Returns the number of male babies delivered by month
	public static function countMaleBirthsByMonth() {
		$query = self::select(array_map('DB::raw', self::maleBirthsSelectStrings()))
            ->groupBy(DB::raw(self::$groupBy))   
            ->orderBy(DB::raw(self::orderBy()))   ;
		return self::applyTimePeriodWhere($query)->get();
	}
	//Returns the number of female babies delivered by month
	public static function countFemaleBirthsByMonth() {
		$query = self::select(array_map('DB::raw', self::femaleBirthsSelectStrings()))
            ->groupBy(DB::raw(self::$groupBy))   
            ->orderBy(DB::raw(self::orderBy()))   ;
		return self::applyTimePeriodWhere($query)->get();
	}
