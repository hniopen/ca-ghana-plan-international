...
Route::get('dwsubmissions/dwSubmission015s', ['as'=> 'dwsubmissions.dwSubmission015s.index', 'uses' => 'Dwsubmissions\DwSubmission015Controller@index']);
Route::post('dwsubmissions/dwSubmission015s', ['as'=> 'dwsubmissions.dwSubmission015s.store', 'uses' => 'Dwsubmissions\DwSubmission015Controller@store']);
Route::get('dwsubmissions/dwSubmission015s/create', ['as'=> 'dwsubmissions.dwSubmission015s.create', 'uses' => 'Dwsubmissions\DwSubmission015Controller@create']);
Route::put('dwsubmissions/dwSubmission015s/{dwSubmission015s}', ['as'=> 'dwsubmissions.dwSubmission015s.update', 'uses' => 'Dwsubmissions\DwSubmission015Controller@update']);
Route::patch('dwsubmissions/dwSubmission015s/{dwSubmission015s}', ['as'=> 'dwsubmissions.dwSubmission015s.update', 'uses' => 'Dwsubmissions\DwSubmission015Controller@update']);
Route::delete('dwsubmissions/dwSubmission015s/{dwSubmission015s}', ['as'=> 'dwsubmissions.dwSubmission015s.destroy', 'uses' => 'Dwsubmissions\DwSubmission015Controller@destroy']);
Route::get('dwsubmissions/dwSubmission015s/{dwSubmission015s}', ['as'=> 'dwsubmissions.dwSubmission015s.show', 'uses' => 'Dwsubmissions\DwSubmission015Controller@show']);
Route::get('dwsubmissions/dwSubmission015s/{dwSubmission015s}/edit', ['as'=> 'dwsubmissions.dwSubmission015s.edit', 'uses' => 'Dwsubmissions\DwSubmission015Controller@edit']);


Route::get('dwsubmissions/dwSubmission017s', ['as'=> 'dwsubmissions.dwSubmission017s.index', 'uses' => 'Dwsubmissions\DwSubmission017Controller@index']);
Route::post('dwsubmissions/dwSubmission017s', ['as'=> 'dwsubmissions.dwSubmission017s.store', 'uses' => 'Dwsubmissions\DwSubmission017Controller@store']);
Route::get('dwsubmissions/dwSubmission017s/create', ['as'=> 'dwsubmissions.dwSubmission017s.create', 'uses' => 'Dwsubmissions\DwSubmission017Controller@create']);
Route::put('dwsubmissions/dwSubmission017s/{dwSubmission017s}', ['as'=> 'dwsubmissions.dwSubmission017s.update', 'uses' => 'Dwsubmissions\DwSubmission017Controller@update']);
Route::patch('dwsubmissions/dwSubmission017s/{dwSubmission017s}', ['as'=> 'dwsubmissions.dwSubmission017s.update', 'uses' => 'Dwsubmissions\DwSubmission017Controller@update']);
Route::delete('dwsubmissions/dwSubmission017s/{dwSubmission017s}', ['as'=> 'dwsubmissions.dwSubmission017s.destroy', 'uses' => 'Dwsubmissions\DwSubmission017Controller@destroy']);
Route::get('dwsubmissions/dwSubmission017s/{dwSubmission017s}', ['as'=> 'dwsubmissions.dwSubmission017s.show', 'uses' => 'Dwsubmissions\DwSubmission017Controller@show']);
Route::get('dwsubmissions/dwSubmission017s/{dwSubmission017s}/edit', ['as'=> 'dwsubmissions.dwSubmission017s.edit', 'uses' => 'Dwsubmissions\DwSubmission017Controller@edit']);


Route::get('dwsubmissions/dwSubmission018s', ['as'=> 'dwsubmissions.dwSubmission018s.index', 'uses' => 'Dwsubmissions\DwSubmission018Controller@index']);
Route::post('dwsubmissions/dwSubmission018s', ['as'=> 'dwsubmissions.dwSubmission018s.store', 'uses' => 'Dwsubmissions\DwSubmission018Controller@store']);
Route::get('dwsubmissions/dwSubmission018s/create', ['as'=> 'dwsubmissions.dwSubmission018s.create', 'uses' => 'Dwsubmissions\DwSubmission018Controller@create']);
Route::put('dwsubmissions/dwSubmission018s/{dwSubmission018s}', ['as'=> 'dwsubmissions.dwSubmission018s.update', 'uses' => 'Dwsubmissions\DwSubmission018Controller@update']);
Route::patch('dwsubmissions/dwSubmission018s/{dwSubmission018s}', ['as'=> 'dwsubmissions.dwSubmission018s.update', 'uses' => 'Dwsubmissions\DwSubmission018Controller@update']);
Route::delete('dwsubmissions/dwSubmission018s/{dwSubmission018s}', ['as'=> 'dwsubmissions.dwSubmission018s.destroy', 'uses' => 'Dwsubmissions\DwSubmission018Controller@destroy']);
Route::get('dwsubmissions/dwSubmission018s/{dwSubmission018s}', ['as'=> 'dwsubmissions.dwSubmission018s.show', 'uses' => 'Dwsubmissions\DwSubmission018Controller@show']);
Route::get('dwsubmissions/dwSubmission018s/{dwSubmission018s}/edit', ['as'=> 'dwsubmissions.dwSubmission018s.edit', 'uses' => 'Dwsubmissions\DwSubmission018Controller@edit']);
